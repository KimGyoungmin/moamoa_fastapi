...
if (kakaoLoginButton) {
    kakaoLoginButton.addEventListener('click', function () {
        location.href = 'https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=d0676b6a43eee5060c15c2f4f33cd546&redirect_uri=http://127.0.0.1:8000/accounts/auth/kakao/callback';
    });
}
